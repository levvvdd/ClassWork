...
print text [7:] # Выведет строку с 7 до конца
print text [:5] # Выведет строку сначала до 5 символа. Анологично  print text [0:5]
print text [:] # Выведет всю строку
print text [-1] # Вывводит последний символ
print text [-1:-14] # Не сработает, выведет пустою строку
